...
const Contact = () => {
  const socialLinks = [
    { 
      ...
      url: "https://www.linkedin.com/in/priyadarshan-r-05a3bb299",
      color: "hover:text-blue-400"
    },
    { 
      name: "GitHub", 
      icon: <FaGithub className="text-2xl" />, 
      url: "https://github.com/R-Priyadarshan",
            ...
            <div className="space-y-6">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <a href="mailto:rr6015@srmist.edu.in" className="text-gray-600 dark:text-gray-400 hover:text-teal-600 dark:hover:text-teal-300 transition-colors duration-300">
                    rr6015@srmist.edu.in
                  </a>
                </div>
              </div>
